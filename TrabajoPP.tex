...
\item Caso 3.
Todos los clanes se intersectan en el vértice $u_1$ y sólo existe otra intersección entre dos de estos clanes. Sin pérdida de generalidad supongamos que los clanes $C_1$ y $C_3$ se intersectan en un vértice $u_2$ y $C_3\cap C_2=\left\{u_1\right\}$ únicamente, como se muestra en la figura~\ref{F3}.
